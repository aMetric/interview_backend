...
import com.coderwhs.interview.annotation.AuthCheck;
...
import com.coderwhs.interview.config.WxOpenConfig;
import com.coderwhs.interview.model.dto.user.UserAddRequest;
import com.coderwhs.interview.model.dto.user.UserLoginRequest;
import com.coderwhs.interview.model.dto.user.UserQueryRequest;
import com.coderwhs.interview.model.dto.user.UserRegisterRequest;
import com.coderwhs.interview.model.dto.user.UserUpdateMyRequest;
import com.coderwhs.interview.model.dto.user.UserUpdateRequest;
...
import static com.coderwhs.interview.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    public BaseResponse<List<Integer>> getUserSignInRecord(Integer year, HttpServletRequest request) {
        ...
        List<Integer> res = userService.getUserSignInRecord(loginUser.getId(), year);
        return ResultUtils.success(res);
    }
}
